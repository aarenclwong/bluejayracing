...
# Form implementation generated from reading ui file 'advanced_window.ui'
#
...
"background-color: qconicalgradient(cx:0.485, cy:0.499909, angle:227.4, stop:0.278607 rgba(66, 66, 66, 255), stop:0.875622 rgba(43, 43, 43, 255));}")
        ...
        self.rpm_label.setGeometry(QtCore.QRect(380, 100, 91, 48))
        ...
        self.speed_label.setGeometry(QtCore.QRect(360, 300, 123, 48))
        self.speed_label.setObjectName("speed_label")
        self.rpm_widget = QtWidgets.QLabel(self.background)
        self.rpm_widget.setEnabled(True)
        self.rpm_widget.setGeometry(QtCore.QRect(540, 260, 200, 200))
        ...
        self.speed_widget.setGeometry(QtCore.QRect(570, 20, 200, 200))
